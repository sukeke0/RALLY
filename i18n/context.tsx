...
export function LanguageProvider({children}:{children:ReactNode}){
 const [language,updateLanguage]=useState<Language>(()=>{const browserLanguage=navigator.languages?.[0]||navigator.language;try{return loadLanguage(window.localStorage,browserLanguage)}catch{return loadLanguage(undefined,browserLanguage)}}),[languageError,setLanguageError]=useState(false);
