...
export default function Home(){
 ...
 <ScoreCards match={match} state={state} disabled={!session.match||locked||session.saveStatus==='error'} onScore={team=>run(()=>session.score(team))}/>{state.winner&&<p className="tap-hint">{t("訂正するときは「戻る」")}</p>}
