...
export default function Home(){
 ...
 {panel==='setup-warning'&&<div className="actions"><button className="primary-button" disabled={locked} onClick={()=>setPanel('setup')}>OK</button><button className="secondary-button" onClick={()=>setPanel(null)}>{t('キャンセル')}</button></div>}
