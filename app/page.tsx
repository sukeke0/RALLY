...
export default function Home(){
 ...
 {panel==='history'&&<MatchHistory repo={session.repo} current={session.match} onDelete={async id=>{await session.remove(id);setEndNotice(false)}} onOpen={async m=>{await session.open(m);setEndNotice(false);setPanel(null)}}/>}
