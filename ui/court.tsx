...
export function Court({match,state,flipped}:{match:Match;state:GameState;flipped:boolean}){
 ...
 const positions=courtPositions(match,state,flipped);
 useLayoutEffect(()=>{
