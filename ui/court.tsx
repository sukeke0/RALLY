...
export function Court({match,state}:{match:Match;state:GameState}){
 ...
 const positions=courtPositions(match,state),firstServer=match.matchType==='doubles'?currentGame(match).initialServer:null;
 useLayoutEffect(()=>{
